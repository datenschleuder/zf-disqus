...
/**
* ZF-Disqus - Endpoint Threads_Create
*
* create a thread
* 
* CAUTION:
...
* @version 1.0
* @see http://disqus.com/api/docs/threads/create/
* @license BSD
*/
final class ZendX_Disqus_Endpoints_Threads_Create implements 
        ZendX_Disqus_Interfaces_Endpoint
{
     ...
     *
     * @param string $id            
     * @return ZendX_Disqus_Endpoints_Threads_Create
     */
    ...
    {
        return array(
                'endpointurl' => 'https://disqus.com/api/3.0/threads/create.json',
                'method' => 'post'
        );
    }
}
